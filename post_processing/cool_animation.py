...
def plot_animation(sample, dataset, preds, title_anim, save = False):
    '''
    ...
    im4 = ax4.imshow(static_tensor2, origin='lower')
    ...
    animated_tensor3 = preds[0, :, feature1]
    im5 = ax5.imshow(animated_tensor3[0], origin='lower')
    ...
    animated_tensor4 = preds[0, :, feature2]
    im6 = ax6.imshow(animated_tensor4[0], origin='lower')
    ...
    im8 = ax8.imshow(animated_tensor5[0], origin='lower')
    ...
    im9 = ax9.imshow(animated_tensor6[0], origin='lower')
